...
class Warrior:
    ...
    def attack(self):
        ...
        # we are adding 0.5, so the game doesn't go on forever
...
class Battle:
    ...
    # also referred to as Class Method (as opposed to Object Method)
    # static method is a method of the class
    @staticmethod
    def getAttackResult(warriorA, warriorB):
        ...
        damage2WarriorB = math.ceil(warriorAAttkAmt - warriorBBlockAmt)
                        #math.ceil converts float to integer e.g. 7.34 to 7
