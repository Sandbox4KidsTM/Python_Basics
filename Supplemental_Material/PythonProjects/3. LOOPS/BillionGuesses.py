# computer will guess any number between 1 and 1 BILLION in 30 or fewer attempts
...
print('Well, ' + myName + ', you think of a number between 1 and 1 Billion')
...
while guessesTaken < 31:
     computerGuess = round((lowerLimit+upperLimit)/2)
